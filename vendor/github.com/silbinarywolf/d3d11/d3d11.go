...
func CreateDevice(pAdapter IDXGIAdapter, driverType DRIVER_TYPE, software HMODULE, flags uint32, featureLevels []FEATURE_LEVEL, sdkVersion uint32) bool {
	/*
